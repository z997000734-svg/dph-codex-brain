...
import codexRemote from '@deepseek-ai/dsh-llm-codex/remote'
...
export type {} from '@deepseek-ai/dsh-llm-codex/remote'
export type { CodexStatus, CodexTaskView } from '@deepseek-ai/dsh-llm-codex/types'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      agentPresetsRemote, commandsRemote, settingsControllerRemote, goalsRemote, llmRemote, codexRemote, dynamicRemote,
