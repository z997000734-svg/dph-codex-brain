...
describe('ChatView', () => {
  ...
  it('keeps a completed Turn folded across the persisted Normal and Compact modes', () => {
    const process = assistant(2, 'inspect', 1, 1)
    const h = makeHarness({
    ...
    // Completed-Turn process folding no longer depends on the transcript view
    // mode: Normal and Compact both fold the process behind the control so the
    // reader sees the final result first and expands the thinking on demand.
